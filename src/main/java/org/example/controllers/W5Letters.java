...
public class W5Letters {

    private static final Logger LOG = LoggerFactory.getLogger(W5Letters.class);

    private final StringBuilder USER_WORD = new StringBuilder();
    private final Byte WORD_LENGTH = 5, TOTAL_ATTEMPTS = 6;
