...
public class W4Letters {

    private static final Logger LOG = LoggerFactory.getLogger(W4Letters.class);

    private final StringBuilder USER_WORD = new StringBuilder();
    private final Byte WORD_LENGTH = 4, TOTAL_ATTEMPTS = 6;
