...
public class W10Letters {

    private static final Logger LOG = LoggerFactory.getLogger(W10Letters.class);

    private final StringBuilder USER_WORD = new StringBuilder();
    private final Byte WORD_LENGTH = 10, TOTAL_ATTEMPTS = 6;
    ...
    @FXML
    Label l00, l01, l02, l03, l04, l05, l06, l07, l08, l09,
