...
public class W6Letters {

    private static final Logger LOG = LoggerFactory.getLogger(W6Letters.class);

    private final StringBuilder USER_WORD = new StringBuilder();
    private final Byte WORD_LENGTH = 6, TOTAL_ATTEMPTS = 6;
